...
.service('PortholeImageService', ['$rootScope', '$http', '$q', 'ConfigService', function($rootScope, $http, $q, ConfigService) {
    ...
    this.getSateliteImage = function(){
      ...
      var altImagePath = "./img/photos/default" + String(altImageNum) + ".jpg";
    ...
    this.bulkLoadImagesInDiv = function(el, idStr, imageObjs, successCallback){ 
  ...
  this.getImagesFromDescription = function(branchObj) {
    ...
    if (log) console.log("PortholeImageService - getImagesFromDescription - branchObj: ", branchObj);
    ...
    var addImage = function(imgPath, useText){
      ...
      if (imgPath === 'img/loaders/defaultbackground.png' ) useText = true;
