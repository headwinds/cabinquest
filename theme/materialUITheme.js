...
const muiConfig = {
    palette: {
        primaryColor: getPrimaryTheme(),
        accentColor: getMoodyPurple()
    }
};

const faintBlack = '#e5c8ec1f'; // try to find hover background color // originally was "(0, 0, 0, 0.12)"
...
const fabDeleteBtnStyle = { backgroundColor: 'black', opacity: 0.3 };
const loginBtnStyle = {
    textTransform: 'none',
    marginTop: 20,
    borderRadius: 10,
...
const primaryBtnStyle = {
    ...
    marginRight: 0,
    borderRadius: 10,
    backgroundColor: getPrimaryTheme(),
    paddingLeft: 10,
    paddingRight: 10,
    paddingBottom: 2,
    paddingTop: 2
...
const accentBtnStyle = {
    ...
    marginRight: 0,
    borderRadius: 10,
    backgroundColor: getMoodyPurple(),
    paddingLeft: 10,
    paddingRight: 10,
    paddingBottom: 2,
    paddingTop: 2
...
const checkboxLabelStyle = { color: '#666' };
...
export const overrideStyles = {
    ...
    errorColor: getAdminRed(),
    saveSpot: {},
    listIconColor: { color: getPurple() },
